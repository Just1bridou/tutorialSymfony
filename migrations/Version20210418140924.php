 ...
 */
final class Version20210418140924 extends AbstractMigration
{
    ...
    public function down(Schema $schema) : void
    {
        ...
        $this->addSql('DROP TABLE __temp__tutorial');
        $this->addSql('CREATE INDEX IDX_C66BFFE9F675F31B ON tutorial (author_id)');
        $this->addSql('CREATE TEMPORARY TABLE __temp__user AS SELECT id, username, email, password, city, zip, address, birthday, is_banned FROM "user"');
        ...
        $this->addSql('INSERT INTO "user" (id, username, email, password, city, zip, address, birthday, is_banned) SELECT id, username, email, password, city, zip, address, birthday, is_banned FROM __temp__user');
