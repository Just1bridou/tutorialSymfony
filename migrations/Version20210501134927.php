 ...
 */
final class Version20210501134927 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('CREATE TABLE achievement (id INTEGER PRIMARY KEY AUTOINCREMENT NOT NULL, target_field VARCHAR(255) NOT NULL, mathematical_operator TEXT CHECK(mathematical_operator IN (\'>\', \'>=\', \'<\', \'<=\', \'==\')) NOT NULL --(DC2Type:MathematicalOperatorEnum)
        , goal DOUBLE PRECISION NOT NULL)');
        $this->addSql('CREATE TABLE user_achievement (id INTEGER PRIMARY KEY AUTOINCREMENT NOT NULL, user_id INTEGER NOT NULL, achievement_id INTEGER NOT NULL)');
        ...
        $this->addSql('CREATE TEMPORARY TABLE __temp__comment AS SELECT id, author_id, tutorial_id, content, created_at FROM comment');
        ...
        $this->addSql('INSERT INTO comment (id, author_id, tutorial_id, content, created_at) SELECT id, author_id, tutorial_id, content, created_at FROM __temp__comment');
        ...
        $this->addSql('DROP INDEX IDX_653627B8A76ED395');
        $this->addSql('DROP INDEX IDX_653627B84B89032C');
        $this->addSql('CREATE TEMPORARY TABLE __temp__post_like AS SELECT id, post_id, user_id FROM post_like');
        $this->addSql('DROP TABLE post_like');
        $this->addSql('CREATE TABLE post_like (id INTEGER PRIMARY KEY AUTOINCREMENT NOT NULL, post_id INTEGER DEFAULT NULL, user_id INTEGER DEFAULT NULL, CONSTRAINT FK_653627B84B89032C FOREIGN KEY (post_id) REFERENCES tutorial (id) NOT DEFERRABLE INITIALLY IMMEDIATE, CONSTRAINT FK_653627B8A76ED395 FOREIGN KEY (user_id) REFERENCES "user" (id) NOT DEFERRABLE INITIALLY IMMEDIATE)');
        $this->addSql('INSERT INTO post_like (id, post_id, user_id) SELECT id, post_id, user_id FROM __temp__post_like');
        $this->addSql('DROP TABLE __temp__post_like');
    ...
    public function down(Schema $schema) : void
    {
        ...
        $this->addSql('CREATE TEMPORARY TABLE __temp__comment AS SELECT id, author_id, tutorial_id, content, created_at FROM comment');
        $this->addSql('DROP TABLE comment');
        $this->addSql('CREATE TABLE comment (id INTEGER PRIMARY KEY AUTOINCREMENT NOT NULL, author_id INTEGER NOT NULL, tutorial_id INTEGER NOT NULL, content VARCHAR(255) NOT NULL, created_at DATETIME NOT NULL)');
        $this->addSql('INSERT INTO comment (id, author_id, tutorial_id, content, created_at) SELECT id, author_id, tutorial_id, content, created_at FROM __temp__comment');
        $this->addSql('DROP TABLE __temp__comment');
        $this->addSql('CREATE INDEX IDX_9474526CF675F31B ON comment (author_id)');
        $this->addSql('CREATE INDEX IDX_9474526C89366B7B ON comment (tutorial_id)');
        ...
        $this->addSql('CREATE TEMPORARY TABLE __temp__post_like AS SELECT id, post_id, user_id FROM post_like');
        $this->addSql('DROP TABLE post_like');
        $this->addSql('CREATE TABLE post_like (id INTEGER PRIMARY KEY AUTOINCREMENT NOT NULL, post_id INTEGER DEFAULT NULL, user_id INTEGER DEFAULT NULL)');
        $this->addSql('INSERT INTO post_like (id, post_id, user_id) SELECT id, post_id, user_id FROM __temp__post_like');
        $this->addSql('DROP TABLE __temp__post_like');
        $this->addSql('CREATE INDEX IDX_653627B84B89032C ON post_like (post_id)');
        $this->addSql('CREATE INDEX IDX_653627B8A76ED395 ON post_like (user_id)');
