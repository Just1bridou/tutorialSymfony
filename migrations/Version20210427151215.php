 ...
 */
final class Version20210427151215 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('CREATE TEMPORARY TABLE __temp__tutorial AS SELECT id, author_id, category_id, title, content, is_published, is_deleted, created_at FROM tutorial');
        ...
        $this->addSql('INSERT INTO tutorial (id, author_id, category_id, title, content, is_published, is_deleted, created_at) SELECT id, author_id, category_id, title, content, is_published, is_deleted, created_at FROM __temp__tutorial');
    ...
    public function down(Schema $schema) : void
    {
        ...
        $this->addSql('CREATE TEMPORARY TABLE __temp__tutorial AS SELECT id, author_id, category_id, title, content, is_published, is_deleted, created_at FROM tutorial');
        $this->addSql('DROP TABLE tutorial');
        $this->addSql('CREATE TABLE tutorial (id INTEGER PRIMARY KEY AUTOINCREMENT NOT NULL, author_id INTEGER NOT NULL, category_id INTEGER NOT NULL, title VARCHAR(255) NOT NULL, content CLOB NOT NULL, is_published BOOLEAN NOT NULL, is_deleted BOOLEAN NOT NULL, created_at DATETIME NOT NULL)');
        $this->addSql('INSERT INTO tutorial (id, author_id, category_id, title, content, is_published, is_deleted, created_at) SELECT id, author_id, category_id, title, content, is_published, is_deleted, created_at FROM __temp__tutorial');
        $this->addSql('DROP TABLE __temp__tutorial');
        $this->addSql('CREATE INDEX IDX_C66BFFE9F675F31B ON tutorial (author_id)');
        $this->addSql('CREATE INDEX IDX_C66BFFE912469DE2 ON tutorial (category_id)');
