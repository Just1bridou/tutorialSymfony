 ...
 */
final class Version20210427150725 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('CREATE TABLE comment (id INTEGER PRIMARY KEY AUTOINCREMENT NOT NULL, author_id INTEGER NOT NULL, tutorial_id INTEGER NOT NULL, content VARCHAR(255) NOT NULL COLLATE BINARY, CONSTRAINT FK_9474526CF675F31B FOREIGN KEY (author_id) REFERENCES "user" (id) NOT DEFERRABLE INITIALLY IMMEDIATE, CONSTRAINT FK_9474526C89366B7B FOREIGN KEY (tutorial_id) REFERENCES tutorial (id) NOT DEFERRABLE INITIALLY IMMEDIATE)');
        ...
        $this->addSql('CREATE TEMPORARY TABLE __temp__tutorial AS SELECT id, author_id, category_id, title, content, is_published, is_deleted FROM tutorial');
        $this->addSql('DROP TABLE tutorial');
        $this->addSql('CREATE TABLE tutorial (id INTEGER PRIMARY KEY AUTOINCREMENT NOT NULL, author_id INTEGER NOT NULL, category_id INTEGER NOT NULL, title VARCHAR(255) NOT NULL COLLATE BINARY, content CLOB NOT NULL COLLATE BINARY, is_published BOOLEAN NOT NULL, is_deleted BOOLEAN NOT NULL, created_at DATETIME NOT NULL, CONSTRAINT FK_C66BFFE9F675F31B FOREIGN KEY (author_id) REFERENCES "user" (id) NOT DEFERRABLE INITIALLY IMMEDIATE, CONSTRAINT FK_C66BFFE912469DE2 FOREIGN KEY (category_id) REFERENCES category (id) NOT DEFERRABLE INITIALLY IMMEDIATE)');
        $this->addSql('INSERT INTO tutorial (id, author_id, category_id, title, content, is_published, is_deleted) SELECT id, author_id, category_id, title, content, is_published, is_deleted FROM __temp__tutorial');
        ...
        $this->addSql('CREATE TEMPORARY TABLE __temp__user AS SELECT id, username, email, password, city, zip, address, birthday, is_banned, roles, is_verified FROM user');
        $this->addSql('DROP TABLE user');
        $this->addSql('CREATE TABLE user (id INTEGER PRIMARY KEY AUTOINCREMENT NOT NULL, username VARCHAR(255) NOT NULL COLLATE BINARY, email VARCHAR(255) NOT NULL COLLATE BINARY, password VARCHAR(255) NOT NULL COLLATE BINARY, city VARCHAR(255) NOT NULL COLLATE BINARY, zip VARCHAR(15) NOT NULL COLLATE BINARY, address VARCHAR(255) NOT NULL COLLATE BINARY, birthday DATE NOT NULL, is_banned BOOLEAN NOT NULL, is_verified BOOLEAN NOT NULL, roles CLOB NOT NULL --(DC2Type:json)
        )');
        $this->addSql('INSERT INTO user (id, username, email, password, city, zip, address, birthday, is_banned, roles, is_verified) SELECT id, username, email, password, city, zip, address, birthday, is_banned, roles, is_verified FROM __temp__user');
    ...
    public function down(Schema $schema) : void
    {
        ...
        $this->addSql('CREATE TEMPORARY TABLE __temp__tutorial AS SELECT id, author_id, category_id, title, content, is_published, is_deleted FROM tutorial');
        $this->addSql('DROP TABLE tutorial');
        $this->addSql('CREATE TABLE tutorial (id INTEGER PRIMARY KEY AUTOINCREMENT NOT NULL, author_id INTEGER NOT NULL, category_id INTEGER NOT NULL, title VARCHAR(255) NOT NULL, content CLOB NOT NULL, is_published BOOLEAN NOT NULL, is_deleted BOOLEAN NOT NULL)');
        $this->addSql('INSERT INTO tutorial (id, author_id, category_id, title, content, is_published, is_deleted) SELECT id, author_id, category_id, title, content, is_published, is_deleted FROM __temp__tutorial');
        $this->addSql('DROP TABLE __temp__tutorial');
        $this->addSql('CREATE INDEX IDX_C66BFFE9F675F31B ON tutorial (author_id)');
        $this->addSql('CREATE INDEX IDX_C66BFFE912469DE2 ON tutorial (category_id)');
        $this->addSql('CREATE TEMPORARY TABLE __temp__user AS SELECT id, username, email, password, city, zip, address, birthday, is_banned, roles, is_verified FROM "user"');
        $this->addSql('DROP TABLE "user"');
        $this->addSql('CREATE TABLE "user" (id INTEGER PRIMARY KEY AUTOINCREMENT NOT NULL, username VARCHAR(255) NOT NULL, email VARCHAR(255) NOT NULL, password VARCHAR(255) NOT NULL, city VARCHAR(255) NOT NULL, zip VARCHAR(15) NOT NULL, address VARCHAR(255) NOT NULL, birthday DATE NOT NULL, is_banned BOOLEAN NOT NULL, is_verified BOOLEAN NOT NULL, roles CLOB NOT NULL COLLATE BINARY --(DC2Type:json)
        )');
        $this->addSql('INSERT INTO "user" (id, username, email, password, city, zip, address, birthday, is_banned, roles, is_verified) SELECT id, username, email, password, city, zip, address, birthday, is_banned, roles, is_verified FROM __temp__user');
        $this->addSql('DROP TABLE __temp__user');
    }
