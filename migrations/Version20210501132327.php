 ...
 */
final class Version20210501132327 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('CREATE TABLE post_book_mark (id INTEGER PRIMARY KEY AUTOINCREMENT NOT NULL, post_id INTEGER DEFAULT NULL, user_id INTEGER DEFAULT NULL)');
        $this->addSql('CREATE INDEX IDX_DE87C78E4B89032C ON post_book_mark (post_id)');
        $this->addSql('CREATE INDEX IDX_DE87C78EA76ED395 ON post_book_mark (user_id)');
    ...
    public function down(Schema $schema) : void
    {
        ...
        $this->addSql('DROP TABLE post_book_mark');
        $this->addSql('DROP INDEX IDX_DADD4A251E27F6BF');
        $this->addSql('CREATE TEMPORARY TABLE __temp__answer AS SELECT id, question_id, content, is_correct FROM answer');
        $this->addSql('DROP TABLE answer');
