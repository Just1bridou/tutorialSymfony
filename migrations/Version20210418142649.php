 ...
 */
final class Version20210418142649 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('CREATE TABLE tutorial (id INTEGER PRIMARY KEY AUTOINCREMENT NOT NULL, author_id INTEGER NOT NULL, category_id INTEGER NOT NULL, title VARCHAR(255) NOT NULL COLLATE BINARY, content CLOB NOT NULL COLLATE BINARY, is_published BOOLEAN NOT NULL, is_deleted BOOLEAN NOT NULL, CONSTRAINT FK_C66BFFE9F675F31B FOREIGN KEY (author_id) REFERENCES "user" (id) NOT DEFERRABLE INITIALLY IMMEDIATE, CONSTRAINT FK_C66BFFE912469DE2 FOREIGN KEY (category_id) REFERENCES category (id) NOT DEFERRABLE INITIALLY IMMEDIATE)');
        ...
        $this->addSql('CREATE TEMPORARY TABLE __temp__user AS SELECT id, username, email, password, city, zip, address, birthday, is_banned, roles FROM user');
        $this->addSql('DROP TABLE user');
        $this->addSql('CREATE TABLE user (id INTEGER PRIMARY KEY AUTOINCREMENT NOT NULL, username VARCHAR(255) NOT NULL COLLATE BINARY, email VARCHAR(255) NOT NULL COLLATE BINARY, password VARCHAR(255) NOT NULL COLLATE BINARY, city VARCHAR(255) NOT NULL COLLATE BINARY, zip VARCHAR(15) NOT NULL COLLATE BINARY, address VARCHAR(255) NOT NULL COLLATE BINARY, birthday DATE NOT NULL, is_banned BOOLEAN NOT NULL, roles CLOB NOT NULL --(DC2Type:json)
        , is_verified BOOLEAN NOT NULL)');
        $this->addSql('INSERT INTO user (id, username, email, password, city, zip, address, birthday, is_banned, roles) SELECT id, username, email, password, city, zip, address, birthday, is_banned, roles FROM __temp__user');
    ...
    public function down(Schema $schema) : void
    {
        ...
        $this->addSql('CREATE TEMPORARY TABLE __temp__user AS SELECT id, username, email, password, city, zip, address, birthday, is_banned, roles FROM "user"');
        $this->addSql('DROP TABLE "user"');
        $this->addSql('CREATE TABLE "user" (id INTEGER PRIMARY KEY AUTOINCREMENT NOT NULL, username VARCHAR(255) NOT NULL, email VARCHAR(255) NOT NULL, password VARCHAR(255) NOT NULL, city VARCHAR(255) NOT NULL, zip VARCHAR(15) NOT NULL, address VARCHAR(255) NOT NULL, birthday DATE NOT NULL, is_banned BOOLEAN NOT NULL, roles CLOB NOT NULL COLLATE BINARY)');
        $this->addSql('INSERT INTO "user" (id, username, email, password, city, zip, address, birthday, is_banned, roles) SELECT id, username, email, password, city, zip, address, birthday, is_banned, roles FROM __temp__user');
        $this->addSql('DROP TABLE __temp__user');
    }
}
